...
public sealed partial class TranslationSection : UserControl
{
    ...
    {
        InitializeComponent();
        Loaded += TranslationSection_Loaded;
    }

    private async void TranslationSection_Loaded(object sender, RoutedEventArgs e)
    {
