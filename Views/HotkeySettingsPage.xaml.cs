...
public sealed partial class HotkeySettingsPage : Page
{
    ...
    public HotkeySettingsPage()
    {
        ...
        Loaded += HotkeySettingsPage_Loaded;
        Unloaded += HotkeySettingsPage_Unloaded;
    }

    private void HotkeySettingsPage_Unloaded(object sender, RoutedEventArgs e)
    {
        SettingsService.Instance.HotkeyService.HotkeyRegistrationChanged -= _onHotkeyRegistrationChanged;
    }

    private void HotkeySettingsPage_Loaded(object sender, RoutedEventArgs e)
    {
